 ...
 * another manager, so it is deliberately NOT protected by the master password. Lossy by
 * nature: KDBX cannot represent a passkey. The .bramble export in the vault list's bulk
 * actions is the lossless route.
 */
